...
//we want to be able to loop over the arrays separately and apply discounts by percentage (25% off) or by ($5 off)
...
// arguably, every sandwich starts with bread, so let’s make a higher order function that returns functions that “make sandwiches” on the specific type of bread
...
//there are two provided functions that we’ll be parsing out into 3 functions so that the repeated parts can be taken care of in function instead of being repeated
